...
def compute_init(device_type="cuda"): # cuda|cpu|mps
    ...
    if is_ddp_requested and device_type == "cuda":
        ...
        if os.environ.get("NANOCHAT_DISABLE_NCCL_DEVICE_ID") == "1":
            # Some virtualized GPU environments expose CUDA/NCCL but reject
            # the newer device_id path during the first barrier.
